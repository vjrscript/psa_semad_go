...
var mainPanel = ui.Panel({
  widgets: [
    ui.Label('MONITORAMENTO: Área Requerida', {fontWeight: 'bold', fontSize: '22px'}), // Exemplo de alteração aqui
...
var area_estudo = area_requerida.filter(ee.Filter.eq('N__mero_do', selectedValue));
